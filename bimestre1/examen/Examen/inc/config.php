...
define('DOCUMENT_ROOT_RELATIVA', '/deber/');
define('DOCUMENT_ROOT', $_SERVER['DOCUMENT_ROOT']);
// incluimos las utilidades
require_once( 'utils.php' );
// Si no hay una sesión creada, redireccionar al index para que inicie sesión.
if( $_SERVER['REQUEST_URI'] != DOCUMENT_ROOT_RELATIVA . 'index.php' and $_SERVER['REQUEST_URI'] != DOCUMENT_ROOT_RELATIVA . 'registro.php' ){
